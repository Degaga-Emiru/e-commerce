        ...
        String htmlContent = """
            ...
            <body>
                <div style="max-width:600px;margin:0 auto;padding:20px;">
                    ...
                    <div style="padding:20px;background:#f9f9f9;">
                        <p>Hello <strong>%s</strong>,</p>
                        <p>This is an automated notification to inform you that your product <strong>%s</strong> is running low on stock.</p>
                        <div style="background:white;padding:15px;text-align:center;margin:15px 0;border:1px solid #ffc107;">
                            <p>Current Stock: <strong style="color:red;font-size:24px;">%d</strong></p>
                        </div>
